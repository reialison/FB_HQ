        ...
        gt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    b && (b.innerHTML = void 0 !== c ? c.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : ""), f[0] && f[0].classList.contains("apexcharts-tooltip-marker") && (l.config.tooltip.marker.fillColors && Array.isArray(l.config.tooltip.marker.fillColors) && (n = l.config.tooltip.marker.fillColors[e]), f[0].style.backgroundColor = n), l.config.tooltip.marker.show || (f[0].style.display = "none");
