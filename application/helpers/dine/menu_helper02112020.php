	...
	$CI =& get_instance();
		...
		$CI->make->sForm("menu/details_db",array('id'=>'details_form'));
			...
			$CI->make->sDivRow();
				...
				$CI->make->sDivCol(4);
					...
					$CI->make->input('Short Description','menu_name',iSetObj($menu,'menu_name'),'Type Short Desc',array('class'=>'rOkay','maxlength'=>40));
	    	...
	    	$CI->make->sDivRow();
				...
				$CI->make->sDivCol(4);
					...
					$CI->make->textarea('Description','menu_short_desc',iSetObj($menu,'menu_short_desc'),'Type Name',array('class'=>'rOkay','maxlength'=>'50'));
	    	...
	    	$CI->make->sDivRow();
				...
				$CI->make->sDivCol(3);
					...
					$CI->make->input('Cost','costing',null,'Price',array('class'=>'rOkay','style'=>'width:120px;'));

				$CI->make->eDivCol();

				$CI->make->sDivCol(3);

					$CI->make->input('Selling Price','cost',null,'Price',array('class'=>'rOkay','style'=>'width:120px;'));
		...
		$CI->make->sDivRow();
			...
			$CI->make->sDivCol(3,'left',3);
				...
				$CI->make->button(fa('fa-save').' Save Details',array('id'=>'save-menu','class'=>'btn-block'),'success');
