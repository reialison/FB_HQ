...
class Dashboard extends Prints {
    ...
    public function index(){
        ...
        $select = 'MAX(`trans_date`) as mdate,branch_code';
        $args = array();
        $group = 'branch_code desc';
        $branch_latest_upload = $this->site_model->get_tbl('store_zread',$args,array(),null,true,$select,$group);
        ...
        $data['code'] = dashboardMain($lastGT,$todaySales,$todayTransNo,$lsu,$ts,$branch_latest_upload,$menus);
        $data['sideBarHide'] = true;
    ...
    public function get_last_gt(){
        ...
        $select = 'MONTH(trans_date),sum(gross_sales) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
            $args3["branch_code"] = $branch_code;          
        }
        ...
        $select2 = 'MONTH(trans_date),sum(gross_sales) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
        if($branch_code != ""){
            $args2["branch_code"] = $branch_code;          
        }
    ...
    public function get_net_sales(){
        ...
        $dates = date("m",strtotime($today));
        // $select = 'MAX(old_gt) as true_grand_total,branch_code';
        $select = 'MONTH(trans_date),sum(net_sales) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
        ...
        // echo num($lastGT);
        $dates2 = date("m",strtotime('"-1 month"'));
        $select2 = 'MONTH(trans_date),sum(net_sales) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
    ...
    public function get_vat_sales(){
        ...
        $dates = date("m",strtotime($today));
        // $select = 'MAX(old_gt) as true_grand_total,branch_code';
        $select = 'MONTH(trans_date),sum(vat_sales) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
        ...
        $dates2 = date("m",strtotime('"-1 month"'));
        $select2 = 'MONTH(trans_date),sum(vat_sales) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
    ...
    public function get_discount_sales(){
        ...
        $select = 'MONTH(trans_date),sum(total_discount) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
        ...
        $lastGT = $gt[0]->true_grand_total;
        $dates2 = date("m",strtotime('"-1 month"'));
        $select2 = 'MONTH(trans_date),sum(total_discount) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
    ...
    public function get_trans_count_sales(){
        ...
        $dates = date("m",strtotime($today));
        // $select = 'MAX(old_gt) as true_grand_tlotal,branch_code';
        $select = 'MONTH(trans_date),sum(tc_total) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
        ...
        $lastGT = $gt[0]->true_grand_total;
        $dates2 = date("m",strtotime('"-1 month"'));
        $select2 = 'MONTH(trans_date),sum(tc_total) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
    ...
    public function get_avg_sales(){
        ...
        $dates = date("m",strtotime($today));
        // $select = 'MAX(old_gt) as true_grand_tlotal,branch_code';
        $select = 'MONTH(trans_date),sum(avg) as true_grand_total,branch_code';
        $args3 = array();
        $join = array();
        $lastGT = 0;
        if($branch_code != ""){
        ...
        $lastGT = $gt[0]->true_grand_total;
        $dates2 = date("m",strtotime('"-1 month"'));
        $select2 = 'MONTH(trans_date),sum(avg) as true_grand_total,branch_code';
        $args2 = array();
        $join2 = array();
        $lastGT2 = 0;
        $perc = 0;
    ...
    function chart_data()
    {
        ...
        $mdata = array();
        for($i=1;$i<=12;$i++){
            $top_sales_loc = $this->site_model->get_data_graph($i,$year,$branch_code);
            if($top_sales_loc){
                foreach ($top_sales_loc as $k => $val) {
                    // echo $val->branch_code;die();
                    $mdata[$val->branch_name][$i] = array('amount'=>$val->sales);
    ...
    {      
        ...
        $top_sales_loc = $this->site_model->get_sales_per_store();
        if($top_sales_loc){
            foreach ($top_sales_loc as $k => $val) 
            {                    
