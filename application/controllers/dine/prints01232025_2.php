...
class Prints extends CI_Controller {
    ...
    #### REPORTS
        ...
        public function print_header($branch_code=null){
    ...
    public function mod_sales_rep_backoffice($asJson=false,$args=array(),$return_print_str=false,$print_date,$branch_code=null){
        ////hapchan
        ini_set('memory_limit', '-1');
        set_time_limit(3600);
        // echo $branch_code;die();
