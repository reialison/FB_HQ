    ...
    //######  
        ...
        public function get_daily_reports(){
            ...
            // if($branch_id){
                // $post['args'] = array('trans_sales.branch_code'=>$branch_id);
            // }
            $trans = $this->trans_sales_no_inactive($post['args'],false,$branch_id);
        ...
        public function trans_sales_no_inactive($args=array(),$curr=false,$branch_code=""){
            $total_chit = 0;
            $chit = array();
            $n_results = array();
            // if($curr){
            ...
            $results = $this->cashier_model->get_trans_sales_no_inactive(null,$args,'',null,$branch_code);
            $orders = array();
            // echo "<pre>",print_r($results),"</pre>";
            // if(count($n_results) > 0){
            //     foreach ($n_results as $nres) {
