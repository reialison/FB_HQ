	...
	<?php elseif($use_js == 'zreadBackJs'): ?>
		...
		$('#search-btn').click(function(){
			...
			var this_url = baseUrl+'prints/check_zreads';
				...
				//dr = $('#daterange').val();
				formData = 'date='+date+'&branch_id='+branch_id+'&terminal_id='+terminal_id+'&terminal_id='+terminal_id+'&json='+json;
				$.post(this_url, formData, function(data){
					console.log(data);
					$('#print-div').html(data.code);
				// });
		...
		$('#print-btn').click(function(){
			...
			var this_url = baseUrl+'prints/check_zreads';
				...
				//dr = $('#daterange').val();
				formData = 'date='+date+'&branch_id='+branch_id+'&terminal_id='+terminal_id+'&json='+json;
				$.post(this_url, formData, function(data){
					console.log(data);
					$('#print-div').print();
		...
		$('#excel-btn').click(function(){
			var formData = 'date='+$('#date').val()+'&branch_id='+$("#branch_id").val()+'&terminal_id='+$("#terminal_id").val(); 
			if($('#date').val() == ""){
				rMsg('Enter Date Range','error');
			}
			if($('#branch_id').val() == ""){
	...
	<?php elseif($use_js == 'SysSalesBackJs'): ?>
		...
		$('#excel-btn').click(function(){
			...
			if($('#branch_id').val() == ""){
				...
				// $.rProgressBar();
				goTo('prints/excel_system_sales?'+formData);
			}
