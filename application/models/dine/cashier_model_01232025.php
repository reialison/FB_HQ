...
class Cashier_model extends CI_Model{
	...
	public function get_trans_sales_discounts($sales_disc_id=null,$args=array(),$branch_code=""){
		...
		$this->db->from('trans_sales'.$sess_id.'_discounts trans_sales_discounts');
		// if($branch_code !=""){
		...
		// }
			$this->db->join('trans_sales'.$sess_id.' trans_sales','trans_sales.sales_id = trans_sales_discounts.sales_id  && trans_sales_discounts.pos_id = trans_sales.pos_id &&  trans_sales_discounts.branch_code = trans_sales.branch_code');
